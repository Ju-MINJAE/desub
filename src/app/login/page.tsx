    ...
    <LoadingWrapper>
      <div className="flex flex-col md:flex-row min-h-full md:min-h-screen">
        <div className="w-full md:w-1/2 md:order-2 mb-[8rem] md:mb-0">
          <div className="relative w-full h-[22.3rem] md:h-full hidden md:flex">
            <Image
        ...
        <div className="w-full min-h-[100vh] md:min-h-auto md:w-1/2 flex flex-col justify-center items-center text-center p-8 md:p-0 md:order-1">
          <div>
